    ...
    <div className="border border-gray-200 dark:border-gray-700 dark:bg-gray-800 rounded-lg p-4  hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-start gap-3 flex-1">
          <div className="w-10 h-10 bg-blue-50 dark:bg-blue-900/20 rounded-lg flex items-center justify-center flex-shrink-0">
            <DockerImageIcon className="h-5 w-5 text-[var(--docker-blue)] dark:text-blue-400" />
          </div>
          <div className="flex-1 min-w-0">
            <h3 className="truncate mb-1 dark:text-gray-100">{name}</h3>
            <div className="flex items-center gap-2">
              <span className="flex items-center gap-1 px-2 py-0.5 bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-200 rounded text-xs">
        ...
        <div className="flex gap-1">
          ...
          >
            <MdContentPasteSearch className="w-4 h-4 text-blue-600 dark:text-blue-400" />
          </button>
          <button
      ...
      <div className="space-y-2 text-sm mb-4">
        <div className="flex justify-between">
          ...
          <span className="text-gray-900 dark:text-gray-100">{FormatBytes(image?.Size || 0)}</span>
        </div>
        <div className="flex justify-between">
          <span className="text-gray-500 dark:text-gray-400">Criado</span>
          <span className="text-gray-900 dark:text-gray-100 text-xs">{EpochToDateStr(image?.Created)}</span>
        </div>
        <div className="flex justify-between">
          <span className="text-gray-500 dark:text-gray-400">Há quanto tempo</span>
          <span className="text-gray-900 dark:text-gray-100 text-xs">{FmtAgo(image?.Created)}</span>
        </div>
      </div>
      ...
      <div className="flex gap-2 pt-3 border-t border-gray-100 dark:border-gray-700">
        <button
          ...
          className="flex-1 px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-sm flex items-center justify-center gap-1 dark:text-gray-200"
        >
